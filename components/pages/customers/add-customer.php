    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <div class="content-area">
                ...
                <form class="sale-form" id="customerForm" action="#" method="post">
    ...
    <script>
        ...
        customerForm.addEventListener('submit', async function(event) {
            ...
            const payload = {
                ...
                credit_limit: normalizeDecimal(document.getElementById('creditLimit').value),
                credit_days: normalizeInteger(document.getElementById('creditDays').value),
                discount_rate: normalizeDecimal(document.getElementById('discount').value),
            ...
            if (!payload.name || !payload.phone_number || !payload.type) {
                Swal.fire({
                    ...
                    text: 'Name, phone number, and customer type are required.'
                });
                return;
            }
            ...
            try {
                ...
                await Swal.fire({
                    ...
                    html: `<strong>${result.data?.customer_id || ''}</strong><br>Customer created successfully.`
                });
                ...
                submitButton.innerHTML = '<i class="fas fa-check"></i> Add Customer';
            }
        });
    </script>
</body>
